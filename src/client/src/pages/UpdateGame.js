...
class UpdateGame extends React.Component {
    ...
    render() {
        ...
        function updateMyGame() {
            ...
            fetch('http://localhost:5554/game/update/' + id, {
                method: 'PUT',
                headers: {
            ...
            if (!zmienna) {
                document.getElementById('messApi').innerHTML =
                    'Your game has an update!'
            }
        }
